...
* **SCENARIO A: WEB / APP / EXTENSION (TypeScript)**
    * **Stack:** **TypeScript 6.x** (Strict), **Vite 7** (Rolldown), **React Native** (Mobile/Desktop), **Expo 5.x** (Managed Workflow).
...
* **SCENARIO C: DATA / SCRIPTS / AI (Python)**
    ...
    * **Project Specific:** `ScannerFlow-Document-Capture-Mobile-App` is a React Native mobile app, therefore, the **Apex Toolchain for SCENARIO A** will be applied.
